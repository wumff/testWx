...
import com.wxmp.wxcms.domain.TbEmp;
import com.wxmp.wxcms.mapper.TbEmpDao;
import com.wxmp.wxcms.service.TbEmpService;
...
public class TbEmpServiceImpl  implements TbEmpService{
	...
	@Resource
	private TbEmpDao sysUserDao;
	
	@Override
	public TbEmp getSysUser(TbEmp sysUser) {
		TbEmp resUser = null;
	 ...
	 */
	@Override
	public TbEmp getSysUserById(String userId) {
		TbEmp resUser = null;
	...
	@Override
	public int updateLoginPwd(TbEmp sysUser) {
		int n = 0;
		try {
