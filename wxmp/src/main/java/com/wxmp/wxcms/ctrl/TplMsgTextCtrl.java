...
import com.wxmp.wxcms.domain.WXTemplate;
...
public class TplMsgTextCtrl extends BaseCtrl {
	...
	public AjaxResult updateText(TplMsgText entity){
		//		Vector<String> params = StringUtil.getMatcherGroup(text, "\w+.DATA");
	...
	@RequestMapping(value = "/getTplList")
	@ResponseBody
	public AjaxResult getTplList(TplMsgText searchEntity) {
		List<WXTemplate> pageList = entityService.getTplList();
		return getResult(searchEntity,pageList);
	}
